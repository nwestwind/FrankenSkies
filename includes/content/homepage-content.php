	...
	<div class="inner-container">
		...
		<div class="row">
			<div class="col s12 m10 offset-m1">
				<blockquote>
					<p>Weather modification is a force multiplier with tremendous power that could be exploited across the full spectrum of war-fighting environment</p>
					<p class="cite">Weather as a Force Multiplier<br>Owning the Weather in 2025<br>1996</p>
				</blockquote>
			</div> 
		</div>
	</div>
